...
CREATE TABLE IF NOT EXISTS authorization_actions (
  ...
  requester_roles TEXT NOT NULL DEFAULT '["cashier","staff","manager","admin"]',
  requester_user_ids TEXT NOT NULL DEFAULT '[]',
  authority_limits TEXT NOT NULL DEFAULT '{}',
  extra_authority TEXT NOT NULL DEFAULT '{}',
  absolute_ceilings TEXT NOT NULL DEFAULT '{}',
...
CREATE TABLE IF NOT EXISTS authorization_requests (
  ...
  approved_payload TEXT NOT NULL DEFAULT '{}',
  bill_snapshot TEXT NOT NULL DEFAULT '{}',
  snapshot_hash TEXT NOT NULL DEFAULT '',
  held_order_id TEXT,
  notified_at TEXT,
  requester_direct_limit REAL,
...
CREATE TABLE IF NOT EXISTS pos_store_settings (
  ...
  require_opening_float_count INTEGER,
  enable_blind_cash_count INTEGER,
  max_drawer_cash_limit REAL,
  require_reason_for_payout INTEGER,
  allow_multiple_shifts_per_terminal INTEGER,
  enable_cashier_x_report INTEGER,
  show_opening_float_at_close INTEGER,
  show_expected_totals_at_close INTEGER,
  show_live_variance_at_close INTEGER,
  show_itemized_tender_breakdown INTEGER,
  require_manager_pin_on_variance INTEGER,
  variance_pin_threshold REAL,
  max_cashier_discount_percent REAL,
  max_cart_discount_amount REAL,
  allow_discount_stacking INTEGER,
  require_reason_for_price_override INTEGER,
  prevent_below_cost_sale INTEGER,
  allow_tax_exemption INTEGER,
  prevent_negative_stock_sale INTEGER,
  require_receipt_for_refund INTEGER,
  require_manager_pin_for_refund INTEGER,
  max_refund_days_limit REAL,
  track_item_voids INTEGER,
  auto_lock_timeout_seconds REAL,
  require_manager_pin_for_cash_drawer_open INTEGER,
  enable_manager_pin_audit_log INTEGER,
  require_pin_void_cart INTEGER,
  require_pin_void_line INTEGER,
  require_pin_reduce_qty INTEGER,
  require_pin_manual_discount INTEGER,
  require_pin_price_override INTEGER,
  require_pin_stock_adjustment INTEGER,
  require_pin_shift_close INTEGER,
  ...
  offline_approval_requires_pin INTEGER,
  online_only_void_cart INTEGER,
  online_only_void_line INTEGER,
  online_only_reduce_qty INTEGER,
  online_only_manual_discount INTEGER,
  online_only_price_override INTEGER,
  online_only_stock_adjustment INTEGER,
  online_only_shift_close INTEGER,
  online_only_edit_tenders INTEGER,
  online_only_terminal_reset INTEGER,
  online_only_refund INTEGER,
  is_synced INTEGER NOT NULL DEFAULT 0,
  sync_status TEXT NOT NULL DEFAULT 'pending'
);
