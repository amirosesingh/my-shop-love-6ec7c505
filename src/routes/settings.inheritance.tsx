...
import { PushToChildrenDialog } from "@/components/pos/settings/PushToChildrenDialog";
import { ScopeSelector, type ScopeChoice } from "@/components/pos/settings/ScopeSelector";
...
export const Route = createFileRoute("/settings/inheritance")({
  head: () => ({
    meta: [
      { title: "Settings Inheritance — Northwind POS" },
      {
        name: "description",
        content:
          "Control how hardware, inventory and system settings inherit from Global to Cluster to Branch, override them locally and push them to child branches.",
      },
      { property: "og:title", content: "Settings Inheritance — Northwind POS" },
      {
        property: "og:description",
        content: "Global, cluster and branch settings with sync and override controls.",
      },
