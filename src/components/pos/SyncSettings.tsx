      ...
      <div className="space-y-3">
        <div className="rounded-md border border-border px-3 py-2">
          ...
          <p className="text-xs text-muted-foreground">
            This device works directly with the central database. Every sale, shift and stock
            change is saved centrally as it happens — nothing is stored on the device and there is
            no queue to push. If the connection drops, the app pauses until it is back.
          </p>
        </div>
