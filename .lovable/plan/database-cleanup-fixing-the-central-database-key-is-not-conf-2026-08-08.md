...
Item 3 changes where category/unit data is stored. If you have categories already saved on the Lovable Cloud side, they will not appear until they are re-entered or copied over. Tell me if you'd rather I leave that alone, and I will do items 1 and 2 only. all the tables/ database should be in my pos database rather than the lovable database