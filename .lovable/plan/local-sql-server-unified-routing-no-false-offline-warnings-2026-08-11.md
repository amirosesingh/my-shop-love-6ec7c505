...
- Every connectivity-flavoured message (sql Database Offline, Connection missing, Server setup/key missing, "saved in locall sql database, will sync") passes through the guard before it is shown.
