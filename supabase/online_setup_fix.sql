-- ============================================================================
-- Northwind POS — online_setup_fix.sql
--
-- Paste this whole file into the SQL editor of the database this POS points
-- at and press Run. It is fully idempotent: running it twice changes nothing.
-- Same content as supabase/migrations/20260816000000_fix_health_check_permissions_and_rpc.sql.
-- ============================================================================
