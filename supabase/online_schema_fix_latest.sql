-- ONE-SHOT SETUP SCRIPT — paste into the SQL editor of the database this POS points at.
-- Safe to run repeatedly: every statement is idempotent and no data is changed.
