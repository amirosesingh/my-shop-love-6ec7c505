-- Receiving invoices: durable, branch-scoped and correctable.
--
-- Purely additive. No table is dropped, no row is deleted, nothing is seeded.
-- Safe to run repeatedly against an existing production database.
