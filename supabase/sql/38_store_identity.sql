-- Identity columns: who rang the sale, who created and last changed it.
...
-- Till accounts must belong to a branch; supervisors may roam.
...
-- Child rows follow their parent's branch on insert as well as update.
...
-- Transfer lines: either end of the transfer may write them.
